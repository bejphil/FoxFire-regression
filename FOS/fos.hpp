...
template < typename T >
Eigen::Matrix<int, Eigen::Dynamic, 1> FOS<T>::ReturnSupport() {
...
template < typename T >
T FOS<T>::compute_intercept( const Eigen::Matrix< T, Eigen::Dynamic, 1 >& x,
                               const Eigen::Matrix< T, Eigen::Dynamic, 1 >& y,
                               const Eigen::Matrix< T, Eigen::Dynamic, 1 >& fit ) {
 ...
 * \return
 */
std::vector< T > FOS<T>::GenerateLambdaGrid (
    const Eigen::Matrix< T, Eigen::Dynamic, Eigen::Dynamic >& X,
    const Eigen::Matrix< T, Eigen::Dynamic, 1 >& Y,
    unsigned int M ) {
...
template < typename T >
Eigen::Matrix< T, Eigen::Dynamic, 1 > FOS< T >::X_weights( const Eigen::Matrix< T, Eigen::Dynamic, Eigen::Dynamic >& X ) {
...
template < typename T >
T FOS< T >::Y_weight( const Eigen::Matrix< T, Eigen::Dynamic, 1 >& Y ) {
    return StdDev( Y );
}

template < typename T >
Eigen::Matrix< T, Eigen::Dynamic, 1 > FOS< T >::RescaleCoefficients(
...
template < typename T >
Eigen::Matrix< int, Eigen::Dynamic, 1 > FOS< T >::ApplyScreening( const Eigen::Matrix< T, Eigen::Dynamic, Eigen::Dynamic >& x,
        const Eigen::Matrix< T, Eigen::Dynamic, 1 >& nu_tilde,
        const T duality_gap,
        const T lambda ) {
...
template < typename T >
void FOS< T >::choose_solver( const Eigen::Matrix< T, Eigen::Dynamic, Eigen::Dynamic >& x,
                                const Eigen::Matrix< T, Eigen::Dynamic, 1 >& y,
                                const Eigen::Matrix< T, Eigen::Dynamic, 1 >& beta,
                                SolverType s_type ) {
...
template < typename T >
void FOS< T >::operator()( const Eigen::Matrix< T, Eigen::Dynamic, Eigen::Dynamic >& x,
                             const Eigen::Matrix< T, Eigen::Dynamic, 1 >& y,
                             SolverType s_type ) {
